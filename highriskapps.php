...
$result = mysqli_query($connection,"SELECT 
    Name, COUNT(Name), MAX(DateAdded), (select Computers from software_matrix.discoveredapplications where discoveredapplications.Name = highriskapps.Name) Computers
FROM
    software_matrix.highriskapps
GROUP BY Name
