...
$result = mysqli_query($connection,"SELECT ID, Name, Version_Oldest, Version_Newest,(select count(*) from software_matrix.applicationsdump where applicationsdump.Name = discoveredapplications.Name and applicationsdump.Version = discoveredapplications.Version_Oldest) Oldest, (select count(*) from software_matrix.applicationsdump where applicationsdump.Name = discoveredapplications.Name and applicationsdump.Version = discoveredapplications.Version_Newest) Newest FROM software_matrix.discoveredapplications where Version_Oldest <> Version_Newest order by Name;");
